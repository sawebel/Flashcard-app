        ...
        <div>
            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <button className="btn btn-danger ml-2 float-right" onClick={() => deleteDeckHandler(deck.id)}>{/*<FontAwesomeIcon icon={faTrash}/>*/}</button> 
                </div>
            </div> 
            <h2>Cards</h2>
            {deck.cards?.map((card) => (
                                ...
                                {card.back}
                                    <div className="d-grid gap-2 float-right">
                                        <Link to={`/decks/${deck.id}/cards/${card.id}/edit`} className="btn btn-secondary text-white">
                                           ...
                                           <button className="btn btn-danger ml-2" onClick={() => deleteCardHandler(card.id)}>{/*<FontAwesomeIcon icon={faTrash}/>*/}</button> 
                                    </div>  
                            </div>
                        </div>
                    </div>
